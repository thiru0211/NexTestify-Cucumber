Feature: ADMIN
  ...
  Background: Admin
    ...
    When To Check Admin Enter username and password are "thirumaran@sankarasoftware.com" and "Thirumaran@55"
    And click the Signin button To Check Admin
    Then Click admin button

  @TC_01
  Scenario: Admin:Search Check
    Given Enter valid username "thirumaran" in the searchbox
    When Enter valid email id "thirumaran@sankarasoftware.com" in the searchbox
    Then Enter valid phone number "8870671200" in the searchbox
  ...
  Scenario: Admin:Filter Check
    ...
    Then Select "Inactive" 3rd Option in status dropdown
    Then Close Admin button
  ...
  Scenario: Admin:User Type Check
    ...
    Then Select "Proctor" 3rd Option in user type dropdown
  ...
  Scenario: ADD USER:Address1 Check
    Given Click Add User button in create admin page
    And Enter valid "Test Street" in address1 tab
    Then Close Admin button

  @TC_29
  Scenario: ADD USER:Address2 Check
    Given Click Add User button in create admin page
    And Enter valid "Test Street" in address2 tab
    Then Close Admin button
  ...
  Scenario: ADD USER:Time Zone Check
    Given Click Add User button in create admin page
    And Enter Time Zone name "America/New_York" in Time Zone tab
    Then Close Admin button

  @TC_38
  Scenario: ADD USER:Time Zone Check
    Given Click Add User button in create admin page
    And Select valid "America/New_York" in timezone tab
    Then Close Admin button
  ...
  Scenario: Admin:Valid Check
    ...
    And Check the status in the grid of the same username
    Then Close Admin button
  ...
  Scenario: Admin:Valid Check
    ...
    And Check alert message is displayed or not
    Then Close Admin button
  ...
  Scenario: Admin:Valid Check
    ...
    Then Click verify email button
    And Check success message is displayed or not
    Then Close Admin button
    
    @TC_55a
  Scenario: Admin:Valid Check
    Given Click User logo button in Top right corner
